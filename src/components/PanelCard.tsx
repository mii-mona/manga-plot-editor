...
export function PanelCard({
  ...
  return (
    ...
    >
      <div
        style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap', marginBottom: 4 }}
      >
        <span
          style={{
            fontFamily: fonts.mono,
            fontSize: 10,
            color: isHero ? C.hero : C.textSub,
            fontWeight: 700,
            minWidth: 20,
          }}
        >
